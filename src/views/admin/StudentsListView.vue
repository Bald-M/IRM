<template>
  ...
  <!-- Add the following features in the future -->
  <!-- Edit & Delete name/id/programme/email/phone/status-->
  <!-- Need to view student form -->
  <!-- Students: /students/details /students/form -->
